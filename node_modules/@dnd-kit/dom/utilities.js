...
function scrollIntoViewIfNeeded(el, centerIfNeeded = false) {
  ...
  if ((overTop || overBottom || overLeft || overRight) && !centerIfNeeded) {
    if (alignWithTop) {
      ...
      parent.scrollTop = el.offsetTop - parent.offsetTop + el.clientHeight - parent.clientHeight;
    }
    if (overLeft) {
      parent.scrollLeft = el.offsetLeft - parent.offsetLeft;
    } else if (overRight) {
      parent.scrollLeft = el.offsetLeft - parent.offsetLeft + el.clientWidth - parent.clientWidth;
    }
  }
}
