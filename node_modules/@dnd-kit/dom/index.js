...
render_fn = function() {
  ...
  const feedback = (_b2 = (_a5 = entityOptions == null ? void 0 : entityOptions.feedback) != null ? _a5 : options == null ? void 0 : options.feedback) != null ? _b2 : "default";
...
var _AutoScroller = class _AutoScroller extends Plugin {
  constructor(manager, options) {
    ...
    const scrollOptions = {
      acceleration: options == null ? void 0 : options.acceleration,
      threshold: typeof (options == null ? void 0 : options.threshold) === "number" ? { x: options.threshold, y: options.threshold } : options == null ? void 0 : options.threshold
    };
    this.destroy = effect(() => {
      if (this.disabled) {
        return;
