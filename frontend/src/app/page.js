      ...
      >
        ...
        <div className={styles.questions}>
          ...
          <Question
            ...
            answer={
              <p>
                ...
                create clean, professional resumes using modern templates. Users
                can enter their information, customize sections, and instantly
                generate a formatted resume ready for job applications.
              </p>
            }
          ></Question>
          ...
          <Question
            ...
            answer={
              <p>
                ...
                formatting and produces structured documents that work well with
                ATS used by many employers to scan and parse resumes.
                <br></br>
                <br></br>
                The platform supports a full set of resume features, including
                customizable sections and professional layouts, while making it
                easy to switch between multiple templates without losing your
                content.
              </p>
            }
          ></Question>
          ...
          <Question
            ...
            answer={
              <p>
                ...
                When you submit a resume online, it is often processed by an ATS
                before a recruiter ever sees it. The system scans resumes for
                keywords, formatting, and relevant experience to determine
          ...
          <Question
            ...
            answer={
              <p>
                You can download your resume as a PDF or as LaTeX source files.
                <br></br>
                <br></br>
                PDF is the most common format for submitting resumes because it
                preserves the layout and formatting across all devices and is
                widely accepted by job applications.
                <br></br>
                <br></br>
                LaTeX export allows you to download the underlying source code
                used to generate the resume, which is useful if you want to
                further customize the template, edit it manually, or compile it
                yourself.
              </p>
            }
          ></Question>
          ...
          <Question
            ...
            answer={
              <p>
                ...
                for and the style you prefer. For most professional or technical
                roles, a clean and simple template works best because it is easy
                for recruiters and ATS to read.
                <br></br>
                <br></br>
                Creative fields may allow for more visually styled templates. In
                general, prioritize clear section headings, readable fonts, and
                a layout that highlights your experience and skills without
                being cluttered.
              </p>
            }
          ></Question>
        ...
        <div className={styles.footer}>
          <div className={styles.rowOne}>
            ...
            <div className={styles.verticalLineSpacer}></div>
